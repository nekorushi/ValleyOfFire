...
public class AllIn1UrpShader : ShaderGUI
{
    ...
    public override void OnGUI(MaterialEditor materialEditor, MaterialProperty[] properties)
    {
        ...
        GUILayout.Label("Lighting Properties", bigLabel);
        materialEditor.ShaderProperty(properties[160], properties[160].displayName);
        materialEditor.ShaderProperty(properties[161], properties[161].displayName);
        materialEditor.ShaderProperty(properties[162], properties[162].displayName);
        materialEditor.ShaderProperty(properties[163], properties[163].displayName);
        materialEditor.ShaderProperty(properties[164], properties[164].displayName);
        MaterialProperty glowLight = properties[164];
