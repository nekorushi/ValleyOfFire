Shader "AllIn1SpriteShader/AllIn1SpriteShaderUiMask"
{
	Properties
	{
		...
		_ShineColor("Shine Color", Color) = (1,1,1,1) // 129
		...
		_HologramStripeColor("Stripes Color", Color) = (0,1,1,1) //136
		_GradBoostX("Boost X axis", Range(0.1, 5)) = 1.2 //137
		_GradBoostY("Boost Y axis", Range(0.1, 5)) = 1.2 //138
		[Toggle()] _GradIsRadial("Radial Gradient?", float) = 0 //139
		_AlphaRoundThreshold("Round Threshold", Range(0.005, 1.0)) = 0.5 //140
		_GrassRadialBend("Radial Bend", Range(0.0, 5.0)) = 0.1 //141

		_ColorChangeTolerance2("Tolerance 2", Range(0, 1)) = 0.25 //142
		_ColorChangeTarget2("Color to change 2", Color) = (1, 0, 0, 1) //143
		[HDR] _ColorChangeNewCol2("New Color 2", Color) = (1, 1, 0, 1) //144
		_ColorChangeTolerance3("Tolerance 3", Range(0, 1)) = 0.25 //145
		_ColorChangeTarget3("Color to change 3", Color) = (1, 0, 0, 1) //146
		[HDR] _ColorChangeNewCol3("New Color 3", Color) = (1, 1, 0, 1) //147

		_Contrast ("Contrast", Range(0, 6)) = 1 // 148
		_Brightness ("Brightness", Range(-1, 1)) = 0 // 149

		[HideInInspector] _MinXUV("_MinXUV", Range(0, 1)) = 0.0 //150
		...
		[HideInInspector] _RandomSeed("_MaxYUV", Range(0, 10000)) = 0.0 //154

		_StencilComp ("Stencil Comparison", Float) = 8 //155
		_Stencil ("Stencil ID", Float) = 0
		_StencilOp ("Stencil Operation", Float) = 0
		_StencilWriteMask ("Stencil Write Mask", Float) = 255
		_StencilReadMask ("Stencil Read Mask", Float) = 255 //159
